...
export const bookapricityTheme = {
  colors: {
    sol:   '#E8A33D',
    resol: { 100:'#FDF0EA',200:'#F9DCCF',300:'#F3BCA4',400:'#EC9271',DEFAULT:'#E2683F',500:'#E2683F',600:'#C6512B',700:'#A03D1E',800:'#772C15',900:'#4C1F11' },
    umbral:{ 100:'#EDF0F6',200:'#D6DDEA',300:'#B2BED4',400:'#7E90B0',DEFAULT:'#35486B',500:'#4E628C',600:'#2B3B58',700:'#293857',800:'#1E2941',900:'#151C2C' },
    bruma: '#8FA3B8',
